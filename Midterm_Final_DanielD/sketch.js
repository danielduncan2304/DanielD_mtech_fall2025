...
if (ellipseX > botX-75 && ellipseY > botY-50 && ellipseY < botY +50){
  xMove = -xMove
}
  // else if (ellipseX > botX){
    //add point for bot
...
if (ellipseX < playerX+75 && ellipseY > playerY-50 && ellipseY < playerY +50){
  xMove = -xMove
}
  // else if (ellipseX < playerX){
     // add point for player 1
...
if (ellipseX < playerX+75 && ellipseY > playerY-50 && ellipseY < playerY +50){
  ...
  //change gameOver requirement to player point or bot point = 5
  //ellipseX hits back wall, gameOver
  if (ellipseX >= width || ellipseX <= 0){
    state = "gameOver";
  }
